<script setup>
import HeaderIntroduction from "@/components/HeaderIntroduction.vue";
import BackgroundSummary from "@/components/BackgroundSummary.vue";
import SkillsProficient from "@/components/SkillsProficient.vue";
